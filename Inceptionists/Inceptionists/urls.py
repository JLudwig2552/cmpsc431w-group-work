...
urlpatterns = patterns('',
    ...
    url(r'^Main/add_user/', 'Main.views.add_user'),
    url(r'^Main/register/', 'Main.views.register'),
    url(r'^Main/login/', 'Main.views.user_login'),
    url(r'^Main/logout/', 'Main.views.user_logout'),
    url(r'^Main/item/(?P<item_name>\w+)','Main.views.itemdetails'),
